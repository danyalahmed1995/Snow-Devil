...
import { Activity, Bell, Bookmark, Boxes, Building2, ChartNoAxesCombined, CircleUserRound, FolderGit2, Gauge, GitPullRequest, Home, Info, LogOut, Network, NotebookPen, PackageSearch, Settings, SlidersHorizontal, Workflow } from 'lucide-react';
...
export function Navigator() {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    'native:commit-graph': <Network size={15} className="icon-flow" />,
