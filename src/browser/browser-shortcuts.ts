...
export const SIDEBAR_SHORTCUTS: ShortcutDefinition[] = [
  ...
  { label: 'CI Health', tabId: 'native:ci-health', family: 'native', nativeKind: 'ciHealth', pinned: false, closable: true },
  ...
  { label: 'Account', tabId: 'github:profile', family: 'browser', browserKind: 'profile', urlTemplate: (login) => `https://github.com/${login}`, pinned: true, closable: false },
