...
export async function fetchCommitDetails(repository: string, sha: string): Promise<CommitGraphDetails> {
  ...
  const summary = { state: 'unknown' as const, total: 0, passed: 0, failed: 0, pending: 0, names: [], states: [] };
